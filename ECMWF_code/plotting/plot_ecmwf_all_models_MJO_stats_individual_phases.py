...
def plot_statistics(stat_type, fcst_type, obs_track):
	...
	for MJO_pairs in [ind_MJO_phases]: #standard_MJO_pairs, alt_MJO_pairs
		...
		if obs_track == "ibtracs":
			...
			title = "ECMWF"+fcst_type+" verified\nagainst IBTrACS"
		...
		plt.savefig("ecmwf_"+fcst_type+".ind_MJO_phases."+stat_type+".vs_"+obs_track+".with_conf_ints.2012-2020.png", dpi=400, bbox_inches='tight')
		plt.close()

for fcst_type in ["det","ctrl", "mean"]: #"hres", "ctrl", "mean", "EPS"
