...
for obs_track in ["analysis", "ibtracs"]:#, ["analysis","ibtracs"]:
	...
	for fcst_type in ["mean", "ctrl"]:
		...
		np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_location_error_per_lead_time_vs_" + obs_track + "_"+fcst_type+".with_confidence_intervals_95.txt",  avg_trerr_all_storms, '%.4f')
		np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_mslp_bias_per_lead_time_vs_" + obs_track + "_"+fcst_type+".with_confidence_intervals_95.txt", avg_mslp_bias_all_storms, '%.4f')
		np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_wind_bias_per_lead_time_vs_" + obs_track + "_"+fcst_type+".with_confidence_intervals_95.txt", avg_wind_bias_all_storms, '%.4f')
	
		np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_number_of_forecasts_included_vs_" + obs_track + "_"+fcst_type+".txt",  all_storms_trerr_wgt, '%.4f')
