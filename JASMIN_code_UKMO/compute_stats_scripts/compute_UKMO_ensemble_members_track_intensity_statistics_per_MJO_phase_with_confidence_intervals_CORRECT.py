...
savedir = "/gws/nopw/j04/klingaman/emerton/ukmo_TIGGE_analysis/track_and_intensity_errors/MJO_phase/"
...
for obs_track in ["analysis", "ibtracs"]:
...
np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_location_error_per_lead_time_vs_ibtracs_EPS.with_confidence_intervals.txt",  avg_trerr_all_storms_ib, '%.4f')
np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_mslp_bias_per_lead_time_vs_ibtracs_EPS.with_confidence_intervals.txt", avg_mslp_bias_all_storms_ib, '%.4f')
np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_wind_bias_per_lead_time_vs_ibtracs_EPS.with_confidence_intervals.txt", avg_wind_bias_all_storms_ib, '%.4f')

np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_location_error_per_lead_time_vs_analysis_EPS.with_confidence_intervals.txt",  avg_trerr_all_storms_an, '%.4f')
np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_mslp_bias_per_lead_time_vs_analysis_EPS.with_confidence_intervals.txt", avg_mslp_bias_all_storms_an, '%.4f')
np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_average_wind_bias_per_lead_time_vs_analysis_EPS.with_confidence_intervals.txt", avg_wind_bias_all_storms_an, '%.4f')		
		
np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_number_of_forecasts_included_vs_ibtracs_EPS.txt",  all_storms_sample_size_ib, '%.4f')
np.savetxt(savedir + str(year1s[0])+"_"+str(year2s[-1])+"_MJO_phase"+str(MJO1)+str(MJO2)+"_number_of_forecasts_included_vs_analysis_EPS.txt",  all_storms_sample_size_an, '%.4f')
