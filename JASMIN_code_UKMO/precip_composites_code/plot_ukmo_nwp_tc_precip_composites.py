...
datadir = "/gws/nopw/j04/klingaman/emerton/ukmo_nwp_analysis/ukmo_nwp_precip_composites/"
...
for lt in [0,1,2,3,4,5,6]:
	...
	for y1, y2 in zip(year1s, year2s):
		...
		infile = datadir + str(lt) + "/ukmo_nwp.comp_pcp_tc." + str(lt) + "-days." + str(y1) + "-" + str(y2) + ".nc"
		print infile
		outfile = "ukmo_nwp.comp_pcp_tc." + str(lt) + "-days." + str(y1) + "-" + str(y2) + "_mmday.png"
		ff = Dataset(infile, 'r')
	...
	if lt == 6:
		...
		infile = datadir + str(lt) + "/ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2009-2010.n320.nc"
		print infile
		outfile = "ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2009-2010.n320_mmday.png"
		ff = Dataset(infile, 'r')
		lons = ff.variables['longitude'][:]
		lats = ff.variables['latitude'][:]
		cdays = ff.getncattr('contributing_days')  # contributing days is a global attribute rather than a variable
	...
	infile = datadir + str(lt) + "/ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2009-2010.n512.nc"
	outfile = "ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2009-2010.n512_mmday.png"
	ff = Dataset(infile, 'r')
	lons = ff.variables['longitude'][:]
	lats = ff.variables['latitude'][:]
	cdays = ff.getncattr('contributing_days')  # contributing days is a global attribute rather than a variable
	...
	infile = datadir + str(lt) + "/ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2014-2015.n512.nc"
	outfile = "ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2014-2015.n512_mmday.png"
	ff = Dataset(infile, 'r')
	lons = ff.variables['longitude'][:]
	lats = ff.variables['latitude'][:]
	cdays = ff.getncattr('contributing_days')  # contributing days is a global attribute rather than a variable
	...
	infile = datadir + str(lt) + "/ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2014-2015.n768.nc"
	outfile = "ukmo_nwp.comp_pcp_tc." + str(lt) + "-days.2014-2015.n768_mmday.png"
	ff = Dataset(infile, 'r')
	lons = ff.variables['longitude'][:]
	lats = ff.variables['latitude'][:]
	cdays = ff.getncattr('contributing_days')  # contributing days is a global attribute rather than a variable
	...
	for res in resolutions:
		...
		outfile = "ukmo_nwp.comp_pcp_tc." + str(lt) + "-days." + res + "_mmday.png"
