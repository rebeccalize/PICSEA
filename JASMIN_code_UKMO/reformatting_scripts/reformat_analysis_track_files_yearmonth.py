...
#UKMO_DIR = "/gws/nopw/j04/klingaman/emerton/analysis_reformatted_track_files_yearmonth"
...
REFORMAT_FILENAME = 'analysis.{0}{1}{2}{3}.tcident'
INTERPOLATE_FILENAME_2 = 'analysis.{0}{1}{2}{3}.tcident.interp'
...
def run_rewrite_track_files(y, m, d, h):
	...
	if os.path.exists(indir):
		...
		pl.rewrite_list_of_track_files(indir, infiles, outfile, 0) #0 is the find_id, where 0 = analysis, 1 = ibtracs, 2 = forecasts
