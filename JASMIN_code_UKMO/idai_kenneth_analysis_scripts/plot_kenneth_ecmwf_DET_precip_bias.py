...
for lt in [0,2,3,4,5]: #
	...
	ecfile = ecdir + "/kenneth_precip_sum_mm_det_lt_"+str(lt)+"days_regridded_to_imerg.nc"
	gpmfile = gpmdir + "analysis.comp_pcp_tc.201904_kenneth.nc"
	outfile_ec = "kenneth_ecmwf_DET_mmday.comp_pcp_tc."+str(lt)+"-days.png"
	outfile_gpm = "kenneth_analysis_gpm_imerg_mmday.comp_pcp_tc.png"
	outfile_bias = "kenneth_ecmwf_DET_vs_gpm_imerg_precip_bias_mmday.comp_pcp_tc."+str(lt)+"-days.png"
	...
	ecfilesum = ecdir + "/kenneth_precip_sum_mm_det_lt_"+str(lt)+"days_regridded_to_imerg.nc"
	...
	outfile_ecsum = "kenneth_ecmwf_DET_mm_total.comp_pcp_tc."+str(lt)+"-days_800mmlegend.png"
	outfile_gpmsum = "kenneth_analysis_gpm_imerg_mm_total.comp_pcp_tc_800mmlegend.png"
	outfile_biassum = "kenneth_ecmwf_DET_vs_gpm_imerg_precip_bias_mm_total.comp_pcp_tc."+str(lt)+"-days_LARGEFONT.png"
