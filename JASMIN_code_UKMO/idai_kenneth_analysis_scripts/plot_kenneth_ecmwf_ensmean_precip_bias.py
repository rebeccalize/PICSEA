...
ecdir = "/gws/nopw/j04/klingaman/emerton/ecmwf/kenneth_precip_analysis_ecmwf/"
...
for lt in [0]: #
	...
	ecfile = ecdir + "/kenneth_precip_sum_mm_ensmean_lt_"+str(lt)+"days.nc"
	gpmfile = gpmdir + "kenneth_analysis.comp_pcp_tc.201904_regridded_to_ensmean_grid.nc"
	outfile_ec = "kenneth_ecmwf_ensmean_mmday.comp_pcp_tc."+str(lt)+"-days.png"
	outfile_gpm = "kenneth_analysis_gpm_imerg_mmday.comp_pcp_tc.png"
	outfile_bias = "kenneth_ecmwf_ensmean_vs_gpm_imerg_precip_bias_mmday.comp_pcp_tc."+str(lt)+"-days.png"
	...
	ecfilesum = ecdir + "/kenneth_precip_sum_mm_ensmean_lt_"+str(lt)+"days.nc"
	...
	outfile_ecsum = "kenneth_ecmwf_ensmean_mm_total.comp_pcp_tc."+str(lt)+"-days_800mmlegend.png"
	outfile_gpmsum = "kenneth_analysis_gpm_imerg_mm_total.comp_pcp_tc_800mmlegend.png"
	outfile_biassum = "kenneth_ecmwf_ensmean_vs_gpm_imerg_precip_bias_mm_total.comp_pcp_tc."+str(lt)+"-days_LARGEFONT.png"
	
	bounds1 = np.linspace(0, 800, 9)
	bounds2 = np.linspace(0,60,7)
	...
	#if lt == 0:
		#pl.map_composite_data(gpmpcp_mmday, lats, lons, outfile_gpm, "SIO2", 'Purples', label2, bounds2)
