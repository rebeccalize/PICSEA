...
for lt in [1]: #0,1,2,3,5
	...
	ecfile = ecdir + "/idai_precip_sum_mm_ensmean_lt_"+str(lt)+"days.nc"
	gpmfile = gpmdir + "idai_analysis.comp_pcp_tc.201903_lt_"+str(lt)+"days_regridded_to_ensmean_grid.nc"
	outfile_ec = "idai_ecmwf_ensmean_mmday.comp_pcp_tc."+str(lt)+"-days.png"
	outfile_gpm = "idai_analysis_gpm_imerg_mmday.comp_pcp_tc."+str(lt)+"-days.png"
	outfile_bias = "idai_ecmwf_ensmean_vs_gpm_imerg_precip_bias_mmday.comp_pcp_tc."+str(lt)+"-days.png"
	...
	outfile_ecsum = "idai_ecmwf_ensmean_mm_total.comp_pcp_tc."+str(lt)+"-days_800mmlegend.png"
	outfile_gpmsum = "idai_analysis_gpm_imerg_mm_total.comp_pcp_tc."+str(lt)+"-days_800mmlegend.png"
	outfile_biassum = "idai_ecmwf_ensmean_vs_gpm_imerg_precip_bias_mm_total.comp_pcp_tc."+str(lt)+"-days.png"
