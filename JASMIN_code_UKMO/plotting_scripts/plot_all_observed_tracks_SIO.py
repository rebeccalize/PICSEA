		...
		for dir in dirs:
			...
			for entry in list_of_all_files:
				if fnmatch.fnmatch(entry,pattern):
					track_file_list.append(datadir+str(y1)+"_"+str(y2)+"/SIO_storms/"+dir+"/"+entry)

#print track_file_list
#outdir="/group_workspaces/jasmin2/klingaman/emerton/ukmo_nwp_analysis/"
outdir="./"
outfile = "all_observed_TCs_SIO_"+str(year1[0])+"_"+str(year2[-1])+".png"
map_all_obs_tracks_SIO(track_file_list, category_list, outfile, "SIO")
